...
# Metin Okuma (Text-to-Speech) Motorunu Başlat
engine = pyttsx3.init()

# YOLO model ve video yolu
model_path = "yolov8n.pt"
video_path = "kampus.mp4"

# Seçtiğiniz sınıf isimlerini yükleme
class_names = []
with open("coco-classes.txt", "r") as f:
    class_names = f.read().strip().split("\n")

# Araç sınıfı numaraları
vehicles = [0, 1, 2, 3, 5, 6, 7, 9, 11]
...
outer_polygon_points = [(399, 712), (890, 714), (916,536), (373, 515)]
outer_polygon = np.array(outer_polygon_points, np.int32)

inner_polygon_points = [(478, 715), (788, 714), (823,586), (443, 567)]
inner_polygon = np.array(inner_polygon_points, np.int32)

# Video'nun genişlik ve yüksekliği
